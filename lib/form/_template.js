                ...
                <div class="_tchainPaymentTokenList">
                    ...
                    <div class="_tchainPaymentToken ${params.tokenName === 'USDT' ? 'active' : ''}">
                        ...
                        <div class="_tchainPaymentTokenContent">
                            ...
                            <div class="_item ${params.usdt.isWarning ? 'warning' : ''}">
                                <div class="_totalLabel">You'll transfer:</div>
                                <div class="_totalAmount"><span class="nfm">${
                                    params.usdt.amountTransfer
                                }</span> USDT</div>
                                ${
                                    params.usdt.isWarning
                                        ? `<div class="_warning">
                                    ${Configs.Icons.Warning}
                                    <span>Insufficient balance to use this token for transfer</span>
                                </div>`
                    ...
                    <div class="_tchainPaymentToken ${params.tokenName === 'BUSD' ? 'active' : ''}">
                        ...
                        <div class="_tchainPaymentTokenContent">
                            ...
                            <div class="_item ${params.busd.isWarning ? 'warning' : ''}">
                                <div class="_totalLabel">You'll transfer:</div>
                                <div class="_totalAmount"><span class="nfm">${
                                    params.busd.amountTransfer
                                }</span> BUSD</div>
                                ${
                                    params.busd.isWarning
                                        ? `<div class="_warning">
                                    ${Configs.Icons.Warning}
                                    <span>Insufficient balance to use this token for transfer</span>
                                </div>`
                    ...
                    <div class="_tchainPaymentToken ${params.tokenName === 'JOY' ? 'active' : ''}">
                        <div class="_tchainPaymentTokenHeader">
                            <div class="_tokenInfo">
                                <div class="_tokenIcon">
                                    ${Configs.Icons.JOY}
                            ...
                            <div class="_tokenAction">
                                <input type="radio" id="_tchain.payment.token.joy" name="_radioTchainPaymentToken" value="JOY" ${
                                    params.tokenName === 'JOY' ? 'checked' : ''
                                } />
                                <label for="_tchain.payment.token.joy"></label>
                            </div>
                        </div>
                        <div class="_tchainPaymentTokenContent">
                            <div class="_item">
                            ...
                            <div class="_item">
                                ...
                                <div><span class="nfm">${params.joy.fee}</span> JOY</div>
                            </div>
                            <div class="_item">
                                <div>Exchange Rate:</div>
                                <div>
                                    1 JOY =~ 
                                    <span class='nfm'>${params.joy.rate}</span>
                                    ${params.currency}
                                </div>
                            </div>
                            <div class="_item ${params.joy.isWarning ? 'warning' : ''}">
                                <div class="_totalLabel">You'll transfer:</div>
                                <div class="_totalAmount"><span class="nfm">${
                                    params.joy.amountTransfer
                                }</span> JOY</div>
                                ${
                                    params.joy.isWarning
                                        ? `<div class="_warning">
                                    ${Configs.Icons.Warning}
                                    <span>Insufficient balance to use this token for transfer</span>
                                </div>`
