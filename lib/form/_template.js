...
<div class="_tchain-container">
    <div class="_tchain-confirm-form">
        ...
        <div class="_tchain-tabs" id="_tchain-tabs">
            <div class="_tchain-tabs-nav">
                <div class="item active" for="_tchain-pay-with-metamask">Metamask</div>
                <div class="item" for="_tchain-pay-with-qrcode">QrCode</div>
            </div>
        </div>
        <div class="_tchain-tabs-content qrcode" id="_tchain-pay-with-qrcode">
            <img id="_tchain.qrcode" src="${params.qrCode}" />
        </div>
        <div class="_tchain-tabs-content metamask active" id="_tchain-pay-with-metamask">
...
._tchain-tabs-nav .item.active {
    background: rgba(0,0,0,0.1);
    transition: 0.3s;
}

._tchain-tabs-content {
    height: 0px;
    opacity: 0;
    overflow: hidden;
    transition: 0.2s;
...
._tchain-tabs-content.qrcode.active{
    position: relative;
    width: 100%;
    background: #FFF;
    padding: 25px;
...
._tchain-tabs-content.metamask.active {
