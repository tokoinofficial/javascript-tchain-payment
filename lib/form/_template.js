            ...
            <div class="_tchainPaymentFormContent">
                <div class="_tchainPaymentFormSummary">
                    ...
                    <div class="_note">
                        ...
                        <div class="value">
                            ...
                            <strong><input type="text" placeholder="Tap to Add" /></strong>
                        </div>
                    </div>
                    ...
                    <div class="_tchainPayWithTokoFee">
                        ...
                        <div>
                            Pay <strong>${params.tokoAmountForDiscount} TOKO</strong> to get <strong>${params.discountPercent}%
                                discount</strong> of the service fee <br />
                                (Balance: <strong><span class="nfm">${params.toko.balance.unitAmount}</span> TOKO</strong>)
                        </div>
                    </div>
                </div>
                ...
                <div class="_tchainPaymentTokenList">
                    <div class="_tchainPaymentToken ${params.tokenName ==='TOKO' ? 'active' : ''}">
                        <div class="_tchainPaymentTokenHeader">
                            ...
                            <div class="_tokenAction">
                                <input type="radio" id="_tchain.payment.token.toko" name="_radioTchainPaymentToken" value="TOKO" ${params.tokenName ==='TOKO' ? 'checked' : ''} />
                        ...
                        <div class="_tchainPaymentTokenContent">
                            ...
                            <div class="_item">
                                ...
                                <div class="_totalAmount"><span class="nfm">${params.toko.amountTransfer}</span> TOKO</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="_tchainPaymentToken ${params.tokenName ==='USDT' ? 'active' : ''}">
                        <div class="_tchainPaymentTokenHeader">
                            ...
                            <div class="_tokenAction">
                                <input type="radio" id="_tchain.payment.token.usdt" name="_radioTchainPaymentToken" value="USDT" ${params.tokenName ==='USDT' ? 'checked' : ''} />
                        ...
                        <div class="_tchainPaymentTokenContent">
                            ...
                            <div class="_item">
                                <div>You will transfer:</div>
                                <div class="_totalAmount"><span class="nfm">${params.usdt.amountTransfer}</span> USDT</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="_tchainPaymentToken ${params.tokenName ==='BUSD' ? 'active' : ''}">
                        <div class="_tchainPaymentTokenHeader">
                            ...
                            <div class="_tokenAction">
                                <input type="radio" id="_tchain.payment.token.busd" name="_radioTchainPaymentToken" value="BUSD" ${params.tokenName ==='BUSD' ? 'checked' : ''} />
                        ...
                        <div class="_tchainPaymentTokenContent">
                            ...
                            <div class="_item">
                                <div>You will transfer:</div>
                                <div class="_totalAmount"><span class="nfm">${params.busd.amountTransfer}</span> BUSD</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="_tchainPaymentFormAction">
                    <div class="_tchainButtons">
                        ...
                        <div class="_btnSubmit ${params.error !== '' ? 'disable' : ''}" id="_tchain.deposit.btn.submit">Confirm</div>
                    </div>
                </div>
            </div>
        </div>
