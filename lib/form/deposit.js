import Configs from '@tokoinofficial/t-chain-payment/lib/config';
...
export default class DepositForm {
    constructor(params = {}) {
        ...
        this._tokenName = configs.Assets[params.token] || configs.DefaultToken;
        this._tokenAddress = configs.Assets[this._tokenName].Address;
        ...
        this._rates = Rates;
        this.discountToken = '0x09b9d0e083a8dc25b979e402c304dbcab574c7af'; // will be updated later.\
    ...
    async getFeeAllToken() {
        try {
            ...
            for (const asset of Object.keys(assets)) {
                const bigAmount = this.amountToBig(asset);
                ...
                if (this._isUseToko) {
                    ...
                    this._serviceFee[asset].feeDiscount = feeDiscount;
                    this._serviceFee[asset].totalFee = feeBig.sub(feeDiscountBig);
                }
            }
