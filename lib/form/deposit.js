...
export default class DepositForm {
    ...
    async getDepositFee(){
        ...
        this._serviceFee = Math.round(this._amount*(depositFee.toNumber() / 10000)*100)/100;
        if (this._isUseToko) {
            this._serviceFeeDiscount = this._amount * this._discountPercent/100;
        } else {
            this._serviceFeeDiscount = 0;
    ...
    async getTransactionFee(){
        ...
        console.log(this._serviceFee, this._serviceFeeDiscount);
        ...
        console.log(this._tokenAddress, window._tpayment.merchant_id, amount, depositFee, this._isUseToko, this._offchain, {gasLimit: Configs.GasLimit});
