...
async function loadEthers() {
    ...
    script.src = 'https://cdnjs.cloudflare.com/ajax/libs/ethers/6.3.0/ethers.umd.min.js';
    script.integrity =
        'sha512-2T4o6X9D1OQ1ZhA48zBlsDV0rUVZD7ddrHpS/a8k0FDSRCbjV4n1LJUQN3BeIawFyWazgGwcjVn1QU5YkaXuqQ==';
...
async function loadWeb3() {
    ...
    if (ethereum !== undefined) {
        ...
        window._tpayment.provider = new ethers.BrowserProvider(ethereum);
...
async function getAddress() {
    return (await window._tpayment.provider.getSigner()).getAddress()
}
